...
const Icons = {
  ...
  car: `<svg data-icon="garage" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 19V8.5L12 4l8 4.5V19"/><path d="M7 19v-7h10v7"/><path d="M8.5 14h7"/><path d="M8.5 16.5h7"/><path d="M9.5 18v-2.2l1.3-2.3h2.4l1.3 2.3V18"/><circle cx="10" cy="18" r="1.1"/><circle cx="14" cy="18" r="1.1"/></svg>`,
